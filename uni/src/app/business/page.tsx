...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `${section.tagline}. AI-powered business and markets stories updated every 10 minutes.`,
    type: "website",
    url: "https://uni-uk.ai/business",
    siteName: "uni-uk.ai",
    images: [{ url: "/logo.png", width: 512, height: 512, alt: "uni-uk.ai - Business & Markets News" }],
  },
  twitter: {
...
export default async function BusinessPage() {
  ...
  let stories: any[] = [];
  try {
    stories = await getSectionPosts('business', 10);
  } catch (error) {
  ...
  return (
    <main className="min-h-screen bg-background">
      <BreadcrumbSchema items={[
        ...
        { name: section.name, url: "https://uni-uk.ai/business" },
      ]} />
      <MainNavigation />
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="lg:grid lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <AdPlaceholder id="biz-101" format="horizontal" />
            ...
            <AdPlaceholder id="biz-102" format="horizontal" />
      ...
      <AdPlaceholder id="biz-301" format="horizontal" className="container mx-auto px-4" />
      ...
      <footer className="border-t border-border py-10">
        <div className="container mx-auto px-4 text-center space-y-4">
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-muted-foreground">
            ...
            <Link href="/business" className="hover:text-foreground transition-colors font-semibold text-foreground">Business</Link>
