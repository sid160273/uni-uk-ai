...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `${section.tagline}. AI-powered sports stories updated every 10 minutes.`,
    type: "website",
    url: "https://uni-uk.ai/sport",
    siteName: "uni-uk.ai",
    images: [{ url: "/logo.png", width: 512, height: 512, alt: "uni-uk.ai - Sport News" }],
  },
  twitter: {
...
export default async function SportPage() {
  ...
  let stories: any[] = [];
  try {
    stories = await getSectionPosts('sport', 10);
  } catch (error) {
    console.error('Error fetching sport stories:', error);
  }
  ...
  return (
    <main className="min-h-screen bg-background">
      <BreadcrumbSchema items={[
        ...
        { name: section.name, url: "https://uni-uk.ai/sport" },
      ]} />
      <MainNavigation />
      ...
      <section className="container mx-auto px-4 pb-8 lg:hidden">
        <div className="space-y-6 pt-8">
          <div id="search-mobile">
            ...
            <p className="text-sm text-muted-foreground mb-3">Knows all trending sports topics</p>
            <SearchBox />
          </div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="lg:grid lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <AdPlaceholder id="sport-101" format="horizontal" />
            ...
            <AdPlaceholder id="sport-102" format="horizontal" />
          ...
          <div className="hidden lg:block lg:col-span-5">
            <div className="lg:sticky lg:top-28 space-y-8">
              ...
              <AdPlaceholder id="sport-201" format="rectangle" />
      ...
      <AdPlaceholder id="sport-301" format="horizontal" className="container mx-auto px-4" />
      ...
      <footer className="border-t border-border py-10">
        <div className="container mx-auto px-4 text-center space-y-4">
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-muted-foreground">
            ...
            <Link href="/sport" className="hover:text-foreground transition-colors font-semibold text-foreground">Sport</Link>
